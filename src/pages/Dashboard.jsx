    ...
    <div className="w-full space-y-4 sm:space-y-6 pt-16 lg:pt-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div className="min-w-0">
          ...
          <p className="text-slate-500 text-xs sm:text-sm">Track your projects and team performance</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-slate-800 mb-3 sm:mb-4">Project Progress</h3>
          <div className="h-64">
            <Charts type="bar" />
          </div>
        </div>
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-slate-800 mb-3 sm:mb-4">Project Status Distribution</h3>
          <div className="h-64">
            <Charts type="pie" />
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 border-b border-slate-200">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 mt-1">Monitor and manage your active projects</p>
            </div>
          </div>
          {/* Search Bar */}
          <div className="flex items-center bg-slate-50 rounded-lg px-3 py-2 border border-slate-200">
            <FiFolder className="text-slate-400 mr-2" size={16} />
            <input
              type="text"
